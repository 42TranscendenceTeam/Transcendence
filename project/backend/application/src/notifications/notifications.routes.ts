...
import { getNotificationsController, getUnreadNotificationsController, readNotificationController, readAllNotificationsController, deleteNotificationController, deleteAllNotificationsController } from "./notifications.controller.js";

const router = Router();

router.get('/', authMiddleware, asyncHandler(getNotificationsController));
router.delete('/', authMiddleware, asyncHandler(deleteAllNotificationsController));
